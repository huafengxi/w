...
from store import _path_is_dir, StoreException
...
def main():
    ...
    web_path = _locate_web_path(os.path.dirname(sys.argv[0]) if sys.argv[0].endswith('/dav.py') else '.')
    os.chdir(web_path)

...
def interp(store, v='echo', src=None, **kw):
    def make_html(html='/w/view/layout.html', meta='<meta name="viewport" content="width=device-width,initial-scale=1"><link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">', **kw):
